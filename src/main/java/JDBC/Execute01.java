...
public class Execute01 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/techproed","postgres","be23282328");
        ...
        System.out.println(result); //false doner cunku data cagirmadik
